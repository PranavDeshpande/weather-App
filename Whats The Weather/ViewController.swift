...
//  Whats The Weather
//
//  Created by NIkhil Tanappagol on 20/06/2017.
...
class ViewController: UIViewController {
    ...
    @IBAction func getWeather(_ sender: AnyObject) {
        ...
        let request = NSMutableURLRequest(url: url) // because we are using series of mutating Url
            // NSurl 1.) it has url and the content
